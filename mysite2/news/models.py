...
class CustomUserManager(BaseUserManager):
    def _create_user(self,email,name,phone,is_admin,is_staff,is_active,status, password = None, **extra_fields):
        if not email :
...
class Customuser(AbstractBaseUser.PermissionsMixin):
    ...
    REQUIRED_FIELD = ['name','password','phone','is_admin','is_staff','is_active']
